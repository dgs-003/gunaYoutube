...
public class YoutubeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    static final String GOOGLE_API_KEY = "AIzaSyBeBHUFiqqyloaRAGbVTyiLdtfYYhWIuRk";
    static final String YOUTUBE_VIDEO_ID = "DVw50_d10kk";
    static final String YOUTUBE_PLAYLIST_ID = "PL3tRBEVW0hiBCAULeDgVBdyKS2mDJGv0T";
...
//        layout.addView(button1);
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "Click the ad and make the creator rich!", Toast.LENGTH_LONG).show();
        }
